...
$origen = $target_file;
//echo $origen;
$destino = $target_dir . md5(basename($_FILES["file"]["name"])).".".$imageFileType;
$destino_temporal=tempnam("tmp/","tmp");

$imagen = getimagesize($origen);
//Sacamos la informaci�n
$ancho = $imagen[0]; 
$alto = $imagen[1];
...
redimensionar_jpeg($origen, $destino_temporal, $nuevo_ancho, $nueva_altura, 60);
